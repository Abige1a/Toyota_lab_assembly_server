...
{
    [Serializable]
    public class UnityTreeInformationRequest : Message
    {
        ...
        public UnityTreeInformationRequest()
        {
            this.mode = new int[0];
            this.object_index = 0;
            this.phase_index = 0;
        ...
        public UnityTreeInformationRequest(int[] mode, int object_index, int phase_index, string system_content, string user_content, UnityImageMsg prompt_image, Geometry.PoseMsg[] user_pose, int[] points, int[] boxes, int user_action_verify, int user_verify_verify)
        {
            this.mode = mode;
        ...
        public static UnityTreeInformationRequest Deserialize(MessageDeserializer deserializer) => new UnityTreeInformationRequest(deserializer);

        private UnityTreeInformationRequest(MessageDeserializer deserializer)
        {
        ...
        {
            return "UnityTreeInformationRequest: " +
